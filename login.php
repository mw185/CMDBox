...
if(isset($_GET['login'])) {     #loginformular senden
    ...
    if ($user !== false && password_verify($password, $user['password'])) { #wenn $user nicht falsch ist und das Passwort aus einem hash gelesen werden kann
        ...
        die('Login erfolgreich. Falls sie nicht automatisch weitergeleitet werden klicken sie bitte hier: <a href="geheim.php">internen Bereich</a>'); #erfolgreich, weiterleiten auf internen Bereich
?>
         <meta http-equiv="refresh" content="5; URL=geheim.php">
<?php
    } else {
